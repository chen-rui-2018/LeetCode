...
/**
 * @author： chenr
 * @date： Created on 2021/6/17 9:31
 * @version： v1.0
 * @modified By:
 */
public class IsNumber_0617 {

    public static void main(String[] args) {
        boolean number = new IsNumber_0617().isNumber(".0.0");
    ...
    public boolean isNumber1(String s) {
        ...
        Pattern base = Pattern.compile(number);
        return base.matcher(s).matches();

    }
    public boolean isNumber(String s) {
        Map<State, Map<CharType,State>> transfer = new HashMap<>(16);
        Map<CharType,State> initiaMap = new HashMap<CharType,State>(3){{
            put(CharType.CHAR_NUMBER,State.STATE_INTEGER);
            put(CharType.CHAR_POINT,State.STATE_POINT_WITHOUT_INT);
            put(CharType.CHAR_SIGN,State.STATE_INT_SIGN);
        }};
        transfer.put(State.STATE_INITIAL,initiaMap);
        ...
        Map<CharType,State> integerMap = new HashMap<CharType,State>(3){{
            put(CharType.CHAR_NUMBER,State.STATE_INTEGER);
        ...
        Map<CharType, State> pointWithoutIntMap = new HashMap<CharType, State>(1) {{
            put(CharType.CHAR_NUMBER, State.STATE_FRACTION);
        }};
